<%--
  ...
  @version $Id: academic_title_manage.jsp,v 1.1 2005/10/16 18:27:20 raedler Exp $
  @since DAPS INTRA 1.0
--%>
<%@ include file="include/manage_header.jsp" %>

    <form name="academicTitleForm" method="post">
...
<!-- BEGIN FIRST ROW AND FIRST COLUMN -->
          ...
          <td>
          <spring:bind path="academicTitle.key">
...
<!-- BEGIN SECOND ROW AND FIRST COLUMN -->
          ...
          <td>
          <spring:bind path="academicTitle.name">
            <input class="form_input" type="text" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}"/>">
          </spring:bind>
          </td>
...
<!-- BEGIN THIRD ROW AND FIRST COLUMN -->
          ...
          <td>
          <spring:bind path="academicTitle.systemLocaleKey">
