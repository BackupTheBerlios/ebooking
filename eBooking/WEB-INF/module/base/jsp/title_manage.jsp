<%--
  ...
  @version $Id: title_manage.jsp,v 1.1 2005/10/16 18:27:23 raedler Exp $
...
<!-- BEGIN THIRD ROW AND FIRST COLUMN -->
          ...
          <td>
          <spring:bind path="title.systemLocaleKey">
